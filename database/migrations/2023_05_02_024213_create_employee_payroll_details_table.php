...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('employee_payroll_details', function (Blueprint $table) {
            ...
            $table->integer('total_days_overtime')->nullable()->default(0);
            $table->decimal('overtime', 10, 0)->nullable()->default(0);
            $table->integer('total_days_support')->nullable()->default(0);
            $table->decimal('support_price', 10, 0)->nullable()->default(0);
            $table->integer('total_days_cor')->nullable()->default(0);
            $table->decimal('cor_price', 10, 0)->nullable()->default(0);
            $table->decimal('total_loan', 10, 0)->nullable()->default(0);
            $table->decimal('loan_payment', 10, 0)->nullable()->default(0);
