...
class ProjectCostPolicy
{
    ...
    {
        return $user->can('view_any_project::cost');
    }
    ...
    {
        return $user->can('view_project::cost');
    }
    ...
    {
        return $user->can('create_project::cost');
    }
    ...
    {
        return $user->can('update_project::cost');
    }
    ...
    {
        return $user->can('delete_project::cost');
    }
    ...
    {
        return $user->can('delete_any_project::cost');
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function replicate(User $user, ProjectCost $projectCost)
    {
