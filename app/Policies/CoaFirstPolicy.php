...
class CoaFirstPolicy
{
    ...
    {
        return $user->can('force_delete_coa::first');
    }
    ...
    {
        return $user->can('force_delete_any_coa::first');
    }
    ...
    {
        return $user->can('restore_coa::first');
    }
    ...
    {
        return $user->can('restore_any_coa::first');
    }
    ...
    {
        return $user->can('replicate_coa::first');
    }
    ...
    {
        return $user->can('reorder_coa::first');
    }
