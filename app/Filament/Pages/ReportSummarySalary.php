...
class ReportSummarySalary extends Page
{
    use HasPageShield;

    protected static ?string $navigationIcon = 'heroicon-o-document-text';
    protected static string $view = 'filament.pages.cash-flow-level2';
    protected static ?string $title = 'Report Summary Salary';
    protected static ?string $navigationLabel = 'Report Summary Salary';
    protected static ?string $slug = 'reports/report-summary-salary';
                            ...
                            DatePicker::make('period_start')
                                ...
                                ->afterStateUpdated(function (callable $get, $state) {
                                    if ($state && $get('period_end')) {
                                        ...
                                        $this->frameSrc = env('APP_URL') . "/reportsummarysalary/pdf/{$startDate}/{$endDate}";
                                    } else {
                                        $this->frameSrc = "";
                                    }
                                }),
